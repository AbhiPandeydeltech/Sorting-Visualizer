...
function enable_buttons() {
  window.setTimeout(function () {
    ...
    sortButton.classList.remove("hovered");
    sortButton.classList.add("inp_genDisable");
    pauseButton.classList.remove("Hovered");
    pauseButton.classList.add("inp_genDisable");
    algoSelected = null;
  }, (c_delay += delay_time));
}
